      ...
      <ScrollArea className="min-h-0 flex-1 pt-2">
        <div className="px-4 pb-4">
                  ...
                  <div key={key} className="text-sm">
                    ...
                    <div className="mt-0.5">
                      {typeof value === "string" && value.length > 100 ? (
                        <pre className="max-h-80 overflow-y-auto rounded-lg bg-muted/50 p-3 text-xs whitespace-pre-wrap text-foreground leading-relaxed">
                          {value}
                        </pre>
          ...
          {(state === "input-streaming" || state === "input-available") && (
            <div className="mt-5 flex items-center gap-2 text-xs text-muted-foreground italic">
              <span
