...
g. 完成 → 更新完角色文件后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/characters/*.md。严禁创建或修改场景文件、world.md、plot.md、timeline.md、debts.md。
...
f. 完成 → 更新完当前场景文件后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/scenes/sXXX.md（当前场景）。严禁修改角色文件、world.md、plot.md、timeline.md、debts.md。
...
h. 完成 → 更新完 world.md 后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/world.md。严禁修改场景文件、角色文件、plot.md、timeline.md、debts.md。
...
i. 完成 → 更新完 plot.md 后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/plot.md。严禁修改场景文件、角色文件、world.md、timeline.md、debts.md。
...
j. 完成 → 更新完 timeline.md 后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/timeline.md。严禁修改场景文件、角色文件、world.md、plot.md、debts.md。
...
k. 完成 → 更新完 debts.md 后立即结束，不要检查或修改其他文件

## 范围限制

你只能操作 .novel/debts.md。严禁修改场景文件、角色文件、world.md、plot.md、timeline.md。
